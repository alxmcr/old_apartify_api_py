...
class Apartment(models.Model):
    ...
    ap_latitude = models.DecimalField("Latitude", max_digits=18, decimal_places=15, null=False)
    ap_longitude = models.DecimalField("Longitude", max_digits=18, decimal_places=15, null=False)
